(() => {
    var e = {
            52954: function(e, r, t) {
                t(9461), t(27624), t(30286), t(8334), t(12338), t(93695), t(60322), t(40941), t(65134), t(41655), t(79858), t(64054), t(27527), t(69078), t(84345), t(76226)
            }
        },
        r = {};
    ...
    t.m = e, (() => {
        ...
        t.t = function(o, n) {
            ...
            e = e || [null, r({}), r([]), r(r)];
            for (var l = 2 & n && o;
                "object" == typeof l && !~e.indexOf(l); l = r(l)) Object.getOwnPropertyNames(l).forEach(e => {
                a[e] = () => o[e]
            });
        ...
        t.O = (r, o, n, i) => {
            ...
            for (var l = 1 / 0, a = 0; a < e.length; a++) {
                for (var [o, n, i] = e[a], f = !0, u = 0; u < o.length; u++)(!1 & i || l >= i) && Object.keys(t.O).every(e => t.O[e](o[u])) ? o.splice(u--, 1) : (f = !1, i < l && (l = i));
                if (f) {
                    e.splice(a--, 1);
                    var c = n();
                    void 0 !== c && (r = c)
    ...
    var o = t.O(void 0, ["672", "924", "90", "471"], function() {
        return t(52954)
    });
    o = t.O(o)
})();